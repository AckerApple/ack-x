export class ackInjector{
  ...
  define(name, $module, initInjectArray){
    var $this = this
    var method = function(){
  ...
  definePath(name,path,initInjectArray){
    var $this = this
  ...
  LoadModule = function(name, $module, $args, injectArray){
