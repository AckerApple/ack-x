...
var ackYear = (function () {
    ...
    ackYear.prototype.setStartDate = function (date) {
        var isObject = typeof (date) == 'object', isYearString = !isObject && !isNaN(Number(date)), isYear = isYearString || (!(0, date_1.method)(date).isDate() && !isNaN(date));
        if (isYear) {
    ...
    ackYear.prototype.getStartDate = function () {
        if (this.date)
            return this.date;
        var d = '1/1/' + (0, date_1.method)(new Date()).year();
    ...
    ackYear.prototype.getYear = function () {
        ...
        return (0, date_1.method)(d).year();
    };
    ackYear.prototype.setYear = function (yyyy) {
        var ExYy = (0, date_1.method)(yyyy);
    ...
    ackYear.prototype.getDateOfLastWeekday = function () {
        var d = this.getStartDate(), addAmount = -(0, date_1.method)(d).dayOfWeek() + 6, dateA = new Date(d.setDate(d.getDate() + addAmount));
